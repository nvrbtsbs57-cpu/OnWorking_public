...
class PaperTrader:
    ...
    def _ensure_price(self, signal: TradeSignal) -> Decimal:
    ...
    def _compute_simulated_pnl_and_fees(
        ...
        *,
        ...
        if prices is not None:
            mark_price = prices.get((chain, symbol))
    ...
    def process_signal(
        ...
        """
        chain = self._normalize_chain(signal.chain)
        ...
        if price <= 0:
            ...
            qty = (signal.notional_usd / price).quantize(Decimal("0.00000001"))
